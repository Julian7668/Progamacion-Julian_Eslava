...
# In[11]:
# ! De entrada codigo horrendo
# ! pero ademas el ´in´ hace que ademas si la lista tiene un 3 al final no se ejecutara el insert
# ! osea en esta el orden no importa. En la mia si
